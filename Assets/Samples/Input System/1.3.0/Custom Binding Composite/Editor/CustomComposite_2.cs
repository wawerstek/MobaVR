...
public class CustomComposite_2 : InputBindingComposite<float>
{
    ...
    public override float ReadValue(ref InputBindingCompositeContext context)
    {
        ...
        var z = (firstPartValue + secondPartValue) / 2f;
        return z;
    ...
    */
    ...
    static CustomComposite_2()
    {
        ...
        //InputSystem.RegisterBindingComposite<CustomComposite_2>();
