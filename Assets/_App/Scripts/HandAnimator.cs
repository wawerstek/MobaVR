...
namespace BNG {
    ...
    public class HandAnimator : MonoBehaviour {
        ...
        public virtual void UpdateAnimimationStates()
        {
            ...
            if(IsAnimatorGrabbable() && !Animator.isActiveAndEnabled) {
                EnableHandAnimator();
            }
            ...
            if (Animator != null && Animator.isActiveAndEnabled && Animator.runtimeAnimatorController != null) {
                ...
                Animator.SetFloat("Flex", _prevGrip);

                Animator.SetLayerWeight(1, _prevThumb);

                //// 0 = pointer finger inwards, 1 = pointing out    
                //// Point is played as a blend
                //// Near trigger? Push finger down a bit
                Animator.SetLayerWeight(2, _prevPoint);
                ...
                if (grabber != null && grabber.HeldGrabbable != null) {
                    ...
                    Animator.SetInteger("Pose", PoseId);
        ...
        void setAnimatorBlend(float min, float max, float input, int animationLayer) {
            Animator.SetLayerWeight(animationLayer, min + (input) * max - min);
        }
        ...
        public virtual bool IsAnimatorGrabbable() {
            return Animator != null && grabber != null && grabber.HeldGrabbable != null && grabber.HeldGrabbable.handPoseType == HandPoseType.AnimatorID;
        }
