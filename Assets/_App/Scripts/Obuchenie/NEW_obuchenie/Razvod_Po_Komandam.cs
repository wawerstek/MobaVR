...
public class Razvod_Po_Komandam : MonoBehaviour
{
    ...
    public BaseGameSession gameSession; //Skript na kotorom visit nash personazh
    ...
    public void RunZona()
    {
...

        {
            ...
            if (playerScript == null)
            {
                if (gameSession != null)
                {
                    playerScript = gameSession.LocalPlayer;
                }
            }

            if (playerScript == null)
            {
                if (spawnerReference != null && spawnerReference.localPlayer != null)
                {
